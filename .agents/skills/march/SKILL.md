...
Mandatory reading:
1. /home/user/sources/syauth/AGENTS.md
   — esp. "Scope Discipline (Non-Negotiable)" and "No estimations". Load-bearing.
2. /home/user/sources/syauth/.agents/skills/journey/SKILL.md
3. /home/user/sources/syauth/.agents/skills/implement/SKILL.md
4. /home/user/sources/syauth/specs/syauth/SPEC.md
   — esp. the §3.2 D1–D8 / §3.3 ML clauses this item touches.
5. /home/user/sources/syauth/docs/known-gaps.md
